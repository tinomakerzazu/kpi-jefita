...
const FALLBACK_HEADERS = [
  ...
  "5. A�os o meses de experiencia en ventas",
  "6. �Cu�nto tiempo tardas en promedio en cerrar una venta?",
  "7. �Cierras la venta en el primer contacto con el cliente?",
  "8. �Sueles ofrecer m�s de un producto por venta?",
  "9. �Aplic�s cross-selling (combos, productos complementarios)?",
  ...
  "13. �Qu� tan seguro(a) te sientes al vender?",
  "14. �Cu�l consideras que es tu mayor dificultad al vender?",
  "15. �Qu� esperas mejorar en esta capacitaci�n?"
];
